...
!~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
!
      USE UTILS_SERAFIN, ONLY : CLOSE_MESH_SRF
      USE UTILS_MED, ONLY : CLOSE_MESH_MED
      USE UTILS_VTK, ONLY : CLOSE_MESH_VTK
      USE UTILS_CGNS, ONLY : CLOSE_MESH_CGNS
...
!
      SELECT CASE (FFORMAT(1:7))
        CASE ('SERAFIN')
          CALL CLOSE_MESH_SRF(FILE_ID,IERR,MESH_NUMBER)
        CASE ('MED    ')
        ...
        CASE DEFAULT
          ...
          WRITE(ERROR_MESSAGE,*) 'CLOSE_MESH: BAD FILE FORMAT: ',FFORMAT
          RETURN
      END SELECT
!
!-----------------------------------------------------------------------
