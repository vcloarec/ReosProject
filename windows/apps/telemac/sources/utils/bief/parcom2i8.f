...
!***********************************************************************
!
!brief    COMPLEMENTS A VECTOR OF I8 INTEGERS AT THE INTERFACES BETWEEN
!+                SUB-DOMAINS.
!+
...
!-----------------------------------------------------------------------
!
      CALL PARACOI8(X1,X2,X3,NPOIN,ICOM,IAN,NPLAN,
     &              MESH%NB_NEIGHB,MESH%NB_NEIGHB_PT%I,MESH%LIST_SEND%I,
     &              MESH%NH_COM%I,MESH%NH_COM%DIM1,MESH%BUF_SENDI8,
     &              MESH%BUF_RECVI8,MESH%BUF_SEND%DIM1)
!
!-----------------------------------------------------------------------
!
      RETURN
