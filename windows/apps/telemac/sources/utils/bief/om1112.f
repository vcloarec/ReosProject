...
6         FORMAT(1X,'OM1112 (BIEF) : TYPDIN UNKNOWN :',A1)
          CALL PLANTE(1)
          STOP
        ENDIF
...
11        FORMAT(1X,'OM1112 (BIEF) : TYPEXN UNKNOWN :',A1)
          CALL PLANTE(1)
          STOP
        ENDIF
!
...
98          FORMAT(1X,'OM1112 (BIEF) : TYPEXM = ',A1,' DOES NOT GO ',
...
13        FORMAT(1X,'OM1112 (BIEF) : TYPDIM UNKNOWN :',A1)
          CALL PLANTE(1)
          STOP
        ENDIF
!
...
!
        ELSEIF(TYPEXM(1:1).NE.'0') THEN
          WRITE(LU,163)
163       FORMAT(1X,'OM1112 (BIEF) : TYPEXM NOT AVAILABLE : ',A1)
          CALL PLANTE(1)
          STOP
        ENDIF
!
...
!
          ...
          XM(IELEM, 4) = XN(IELEM, 1)
          XM(IELEM, 5) = XN(IELEM, 6)
          XM(IELEM, 6) = XN(IELEM, 8)
          XM(IELEM, 7) = XN(IELEM, 2)
          XM(IELEM, 8) = XN(IELEM, 4)
...
711       FORMAT(1X,'OM1112 (BIEF) : TYPEXM UNKNOWN :',A1)
          CALL PLANTE(1)
          STOP
        ENDIF
!
...
!
        WRITE(LU,41) OP
41      FORMAT(1X,'OM1112 (BIEF) : UNKNOWN OPERATION : ',A8)
        CALL PLANTE(1)
        STOP
!
      ENDIF
