...
!
      ...
      DOUBLE PRECISION Q1,Q2,Q3,Q4,Q5,Q6,H1,H2,H3,SHT,DIFFU,DIFFV
!
...
!
!
      W1(IELEM)=(((Z5+3*Z4-3*Z3-Z2)*(-(2*V1-V6)*Y2-(2*U1-U6)*X2)
...
!
      W2(IELEM)=(((Z6+4*Z5+3*Z4-4*Z3-4*Z2)*(-V1*Y2-U1*X2)
...
!
      W3(IELEM)=(((3*Z6+2*Z5+3*Z4-6*Z3-2*Z2)*(-V1*Y2-U1*X2)
...
!
      W4(IELEM)=(((-3*Z6+Z5+6*Z4-3*Z3-Z2)*(-V1*Y2-U1*X2)
...
!
      W5(IELEM)=(((-Z6+2*Z5+3*Z4-2*Z3-2*Z2)*(-V1*Y2-U1*X2)
     ...
     &          +(-2*Z5+2*Z4-Z2)*(-(V6-V3)*Y3-(U6-U3)*X3))*XS144)**2
!
      W6(IELEM)=(((-2*Z6+Z5-3*Z4+2*Z3+2*Z2)*(-V1*Y3-U1*X3)
...
!
      W1(IELEM)=W1(IELEM)+((U4-U1+DIFFU)*COEF
...
!
      W2(IELEM)=W2(IELEM)+((U5-U2+DIFFU)*COEF
...
!
      W3(IELEM)=W3(IELEM)+((U6-U3+DIFFU)*COEF
...
!
      W4(IELEM)=W4(IELEM)+((U4-U1+DIFFU)*COEF
...
!
      W5(IELEM)=W5(IELEM)+((U5-U2+DIFFU)*COEF
     ...
     &        +(Q6-Q3)*Y3*(-2*Z5+2*Z4-Z2) )*XS144)**2
!
      W6(IELEM)=W6(IELEM)+((U6-U3+DIFFU)*COEF
...
!
      W1(IELEM)=W1(IELEM)+((V4-V1+DIFFV)*COEF
...
!
      W2(IELEM)=W2(IELEM)+((V5-V2+DIFFV)*COEF
...
!
      W3(IELEM)=W3(IELEM)+((V6-V3+DIFFV)*COEF
...
!
      W4(IELEM)=W4(IELEM)+((V4-V1+DIFFV)*COEF
...
!
      W5(IELEM)=W5(IELEM)+((V5-V2+DIFFV)*COEF
     ...
     &        +(Q6-Q3)*X3*(-2*Z5+2*Z4-Z2) )*XS144)**2
!
      W6(IELEM)=W6(IELEM)+((V6-V3+DIFFV)*COEF
