...
!
!***********************************************************************
! BIEF   V7P2                                   21/08/2016
!***********************************************************************
!
!brief    FIRST STEP TO COMPUTE TURBULENT PRODUCTION TERM
...
!
        FACT = (( X2*U31-X3*U21+Y2*V31-Y3*V21)**2)* XSUR12 /
     &          SURFAC(IELEM)
!
        W1(IELEM) = FACT
        W2(IELEM) = FACT
