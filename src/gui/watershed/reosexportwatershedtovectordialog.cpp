...
{
  QString fileName = QFileDialog::getSaveFileName( nullptr, tr( "Export watershed delineating" ), "", "*.shp" );
...
{
  QString fileName = QFileDialog::getSaveFileName( nullptr, tr( "Export watershed longest path" ), "", "*.shp" );
