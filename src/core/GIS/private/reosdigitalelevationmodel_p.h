...
class ReosDigitalElevationModelRaster : public ReosDigitalElevationModel
{
  public:
    ...
    QVector<QVector<float>> classifyElevationOnGrid( const ReosRasterMemory<unsigned char> &grid, const ReosRasterExtent &gridExtent, ReosProcess *process = nullptr ) const override;
