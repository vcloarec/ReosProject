...
class ReosMeshFrame_p : public ReosMesh
{
  ...
  public:
    ...
    bool rasterizeDatasetValue( const ReosMeshDatasetSource *datasetSource, const QString &fileName, int sourceGroupindex, int datasetIndex, double resolution ) const override;
