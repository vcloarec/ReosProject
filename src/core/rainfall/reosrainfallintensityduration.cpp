...
void ReosRainfallIntensityDuration::setReturnPeriod( const ReosDuration &retour )
{
  mReturnPeriod = retour;
}

void ReosRainfallIntensityDuration::setUnitTime( const ReosRainfallIntensityDuration::UnitTime &unite )
{
  mUnitTime = unite;
}
...
ReosDuration ReosRainfallIntensityDuration::returnPeriod() const
{
  return mReturnPeriod;
}

ReosRainfallIntensityDuration::UnitTime ReosRainfallIntensityDuration::untiTime() const
{
  return mUnitTime;
}
...
unsigned int ReosRainfallIntensityDuration::getNumberCoef() const
{
  return static_cast<unsigned int>( coefficient.size() );
}
...
void ReosRainfallIntensityDuration::setCoefficients( const std::vector<std::vector<double> > &coef )
{
  coefficient = coef;
}

void ReosRainfallIntensityDuration::setPasTemps( const std::vector<ReosDuration> &pdt )
{
  pasTemps = pdt;
}
