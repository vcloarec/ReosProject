...
class ReosWatershedDelineatingProcess : public ReosProcess
{
  ...
  public:
    ...
    QList<double> areaToElevationMean() const;
    QList<double> areaToElevationStd() const;
  ...
  private:
    ...
    QList<double> mAreaToElevationMean;
    QList<double> mAreaToElevationStd;
...
class REOSCORE_EXPORT ReosWatershedDelineating : public ReosModule
{
  ...
  public:
    ...
    struct DelineateResult
    {
        ...
        QList<double> areaToElevationMean;
        QList<double> areaToElevationStd;
    };
