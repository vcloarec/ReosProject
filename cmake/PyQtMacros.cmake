...
IF(BUILD_WITH_QT6
  ...
  OR "${QT_VERSION_BASE}" STREQUAL "Qt6")
  SET(PYQT_BUILD_WITH_QT6 TRUE)
ELSE()
  SET(PYQT_BUILD_WITH_QT6 FALSE)
ENDIF()

IF(PYQT_BUILD_WITH_QT6)
  SET(PYUIC_PROG_NAME pyuic6)
  SET(PYUIC_PROG_NAMES pyuic6 pyuic6.exe pyuic6.bat)
ELSE()
  SET(PYUIC_PROG_NAME pyuic5)
  SET(PYUIC_PROG_NAMES pyuic5 pyuic5.exe pyuic5.bat)
...
IF(NOT PYUIC_PROGRAM)
  ...
  IF (NOT PYUIC_PROGRAM)
    MESSAGE(FATAL_ERROR "${PYUIC_PROG_NAME} not found - aborting")
...
IF(NOT PYRCC_PROGRAM AND NOT PYQT_BUILD_WITH_QT6)
...
ENDIF(NOT PYRCC_PROGRAM AND NOT PYQT_BUILD_WITH_QT6)
